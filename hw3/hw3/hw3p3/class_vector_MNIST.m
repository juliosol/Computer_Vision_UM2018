function [avg_error_prediction_MNIST,avg_acuracy_prediction_MNIST, prediction_vector_MNIST] = class_vector_MNIST(train_images_input,train_labels_input,test_images_input, test_labels_input,k,epsilon_k,epsilon)
...
prediction_vector_MNIST = zeros(qty_numbers_test,1);
error = 0;
...
for i = 1:qty_numbers_test
    ...
    prediction_vector_MNIST(i,1) = min_k_face_class; 
end  

difference = (test_labels == prediction_vector_MNIST);
...
avg_error_prediction_MNIST = no_wrong_predictions/qty_numbers_test;
avg_acuracy_prediction_MNIST = correct_predictions/qty_numbers_test;
